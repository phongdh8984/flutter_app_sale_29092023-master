...
class _CartContainerState extends State<CartContainer> {
                ...
                return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return _buildItemFood(itemProduct, () {
                        _bloc?.eventSink.add(UpdateProductCartEvent(idCart,itemProduct?.id ?? "",itemProduct?.quantity ?? 0));
                      });
                    }
                );
              }
  ...
  Widget _buildItemFood(Product? product, Function()? eventUpdateQuantity) {
